        ...
        <>
            ...
            <div className="carousel w-full pt-20 lg:pt-0">
                <div id="slide1" className="carousel-item  relative w-full">
                    ...
                    <div className="absolute rounded-xl flex justify-center text-center items-center h-full w-full right-0 bottom-0 bg-gradient-to-tr from-[#15151531] to-[#15151538]">

                        <div className='text-white  space-y-0 lg:space-y-7 lg:pr-12 w-1/2'>
